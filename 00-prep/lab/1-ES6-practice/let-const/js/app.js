...
function displayPics(){
  ...
  // By changing 'var' to 'let' we create a scope issue in that we declare the variable rando inside the block function displayPics, since displayPics makes use of the makeRandom function, which is not in the block scope of displayPics.
  console.log(viewed);
